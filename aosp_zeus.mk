...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BuildDesc="zeus_global-user 15 AQ3A.241006.001 OS2.0.6.0.VLBMIXM release-keys" \
    BuildFingerprint=Xiaomi/zeus_global/zeus:15/AQ3A.241006.001/OS2.0.6.0.VLBMIXM:user/release-keys \
    DeviceProduct=zeus \
